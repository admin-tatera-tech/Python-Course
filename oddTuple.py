def oddTuples(aTup):
    ...
    for i in aTup:
        ...
        however it is not checking the index and cutting some numbers 
        out or returning ones that shouldnt be returned
        '''
...
#test tuple that fails, should return 17, 1, 13, 0, 4
